          ...
          <div className="bg-white mt-12 pb-6 w-full justify-center items-center overflow-hidden md:max-w-xl rounded-lg shadow hover:shadow-medium mx-auto mb-20">
            <div className="relative h-40">
              <img
                ...
                alt="Smart Panas"
                src="/assets/media/smart-panas.png"
              />
            </div>
            ...
            <div className="mt-16">
              ...
              <p className="text-sm text-gray-600 text-center">
                <a
                  ...
                  href="mailto:ishandongol@gmail.com?subject=Contact%20|%20Portfolio"
                >
              ...
              {social.map((profile) => {
                return (
                  <a
                    key={profile.link}
                    href={profile.link}
                    className="mr-2 my-6 md:my-3 block md:flex-auto w-full md:w-auto "
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <Badge
                    ...
                    >
                       <FontAwesomeIcon className="mr-2" icon={findIconDefinition({prefix:'fab',iconName:profile.icon as any})}/>
                     {profile.id}
                    </Badge>{" "}
                  </a>
                );
