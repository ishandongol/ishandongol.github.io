    ...
    <footer className="bg-accent-1 border-t border-accent-2">
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center">
          ...
          <div className="font-bold text-center lg:text-left text-xl mb-5">
          <HeaderLogo/>
          </div>
            <h3 className="text-3xl lg:text-5xl font-bold tracking-tighter text-sajilo leading-tight text-center lg:text-left mb-2 lg:mb-0 lg:pr-4">
