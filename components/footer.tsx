        ...
        <div className="py-28 flex flex-col lg:flex-row items-center">
          <div className=" lg:w-3/4">
            ...
            <div className="mb-12 lg:mb-0 lg:inline-flex text-center">
              {skills.map((skill) => {
                return (
                  <i className={`flex-1 hover:text-sajilo text-gray-600 lg:text-gray-500 text-center pl-2 pr-2 pt-4 lg:pt-6 lg:pl-0 lg:pr-4 text-3xl lg:text-6xl lab la-${skill.name}`}></i>
                )
              })}
            </div>
          </div>
          <div className="flex mt-4 flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/4">
            <Link href="/contact">
              <a
                className="mx-3 w-full lg:w-auto bg-sajilo hover:bg-white hover:text-sajilo border border-sajilo text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0 rounded"
              >
                Contact Now
            </a>
            </Link>
