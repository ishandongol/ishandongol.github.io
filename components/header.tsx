      ...
      <Container>
        ...
        <HeaderLogo/>
          ...
          <div className={`text-sm lg:flex-grow ${toggled ? '':'hidden'} lg:inline`}>
            ...
            <a href="https://ishandongol.github.io/assets/ishan_dongol_2021.pdf" target="_blank" className="inline-block text-sm px-4 py-2 leading-none border-2 rounded-full mr-4 hover:shadow-md text-gray-700"  rel="noreferrer noopener" >Résumé</a>
            <Link href="/contact">
