...
const Intro = () => {
  return (
    <section className="h-calculated grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <Skills star containerClassName="mb-12 mt-1 lg:mt-0 text-center lg:text-left" iconClassName="hover:text-sajilo-yellow text-gray-700 lg:pl-0 lg:pr-4 pl-2 pr-2 pt-4 lg:pt-6 text-6xl lg:text-7xl"/>
