...
const Intro = () => {
  return (
    <section className="h-calculated lg:grid lg:grid-cols-3 gap-4">
      <div className="lg:col-span-1 h-auto lg:h-calculated flex flex-col-reverse">
      <Skills star containerClassName="mb-12 lb:mb-6 text-center lg:text-left" iconClassName="hover:text-sajilo-yellow text-gray-700 pr-4 pt-4 lg:pt-6 text-3xl lg:text-6xl text-center"/>
